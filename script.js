onload = ()=>{
  ...
  postos.forEach((posto)=>{
    //qtddContainer.push(posto.codigo);
    let container = document.createElement("div");

    container.classList.add("item");
    container.classList.add("cor-fundo");
    
    creatingContainer(container, posto);
    box.appendChild(container);
  })
  //console.log(qtddContainer.length);
}

function creatingContainer(container, posto){

  creatingIndice(container, posto);
  creatingLeftSide(container, posto);
  creatingRightSide(container, posto);

}

function creatingRightSide(container, posto){
...
function creatingLeftSide(container, posto){
